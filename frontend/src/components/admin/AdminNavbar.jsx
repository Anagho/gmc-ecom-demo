...
const AdminNavbar = () => {
  ...
  return (
    <nav className="bg-gray-200 shadow-md p-2 flex justify-between items-center">
      <h1 className="font-semibold text-lg md:text-xl text-green-700">Admin Dashboard</h1>
